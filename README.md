...
## How I run it
- `npm test` (vitest, 54 passing), `npm run verify` (typecheck + lint + tests + build, all green to count), `npm run build` (static dist), `npm start` serves dist on 8000, `npm run dev` for local dev.
- needs Node 20+.
