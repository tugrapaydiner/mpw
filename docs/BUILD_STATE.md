# build state (updated 2026-09-03, P31)

WEBMCP_SMOKE_REAL=PASS
PRODUCTION_WEBMCP_AUTOMATED=PASS
NEXT=P32 (P27 live-browser gate + P29 trials still need the human)
...
tests: 182 passing, 28 files. seeds pinned (sim mpw-canonical-v1, boot mpw-boot-v1). red-team suite: 6 mutation tests.
...
head: b94e75f1f042d90f9ceddb785241a1212f374aeb
