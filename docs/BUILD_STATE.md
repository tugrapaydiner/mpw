# build state (updated 2026-09-03, P32)

WEBMCP_SMOKE_REAL=PASS
PRODUCTION_WEBMCP_AUTOMATED=PASS
NEXT=P33 (P27 live-browser gate + P29 trials still need the human)
...
tests: 183 passing, 28 files. seeds pinned (sim mpw-canonical-v1, boot mpw-boot-v1). red-team suite: 6 mutation tests.
...
head: f5a10adb2b689753fadbc6b51dd822a4f055bf88
